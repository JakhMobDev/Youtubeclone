...
class HomeScreen extends StatefulWidget {
  ...
  /// Shorts bosilganda MainScreen ga xabar beradi
  /// MainScreen bu callback orqali Shorts tabiga o'tadi
  final Function(int index, List<VideoModel> shorts)? onShortsTab;

  const HomeScreen({super.key, this.onShortsTab});
          ...
          child: _isShortsLoading
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                // ✅ YANGI: callback bo'lsa MainScreen ga xabar beradi
                // bo'lmasa oddiy Navigator.push
                onTap: () {
                  if (widget.onShortsTab != null) {
                    /// MainScreen ga xabar beradi
                    /// index — qaysi short bosildi
                    /// _shorts — barcha shorts ro'yxati
                    widget.onShortsTab!(index, _shorts);
                  } else {
                    /// Fallback — Navigator orqali ochiladi
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        /// Views bo'lsa chiqaradi, bo'lmasa channel nomi
